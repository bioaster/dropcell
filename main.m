...
[centers_droplet, ...
 ...
 [overlay_fullname_field] = visualize_detected_droplets(image_BF, folderesults, ...
                                                          field_number, ...
                                                          time_number, ...
                                                          centers_droplet, ...
                                                          radii_droplet, ...
...
[xx, yy, map_droplets] = build_droplet_map(image_BF, centers_droplet, ...
                                           radii_droplet, n_droplets);

% fprintf('Droplet analysis \n');
% % i_droplet_initial=1;
% % i_droplet_final=n_droplets;
% i_droplet_initial=10;
% i_droplet_final=20;
% for i_droplet = i_droplet_initial:i_droplet_final
% fprintf('Droplet n=%d over %d\n',i_droplet,n_droplets);
% [LOIC, numObjC, ...
%  MR, overlay_fullname_droplet] = droplet_analysis(image_BF, image_CY5, ...
%                                                   field_number, ...
%                                                   time_number, ...
%                                                   i_droplet, ...
%                                                   map_droplets, ...
